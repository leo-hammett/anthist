    ...
    <footer className="bg-[#0a0a0a] text-gray-400 py-16 md:py-20">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12 mb-12">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-sm leading-relaxed mb-6 max-w-md">
              Your personal anthology. Curate content you love, read without distractions.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href="#get-started" className="text-sm hover:text-white transition-colors">
                  Get Started
                </a>
              </li>
            </ul>
        ...
        <div className="pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm">
            © {currentYear} Anthist. Open source under MIT license.
          </p>
          <p className="text-sm">
            Made with ❤️ for mindful readers everywhere
          </p>
        </div>
      </div>
    </footer>
