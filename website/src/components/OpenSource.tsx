export default function OpenSource() {
  return (
    <section className="py-24 md:py-32 bg-gradient-to-br from-indigo-600 via-purple-600 to-indigo-700 text-white relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
        ...
        <p className="text-xl text-white/80 max-w-2xl mx-auto mb-10 leading-relaxed">
          Anthist is fully open source because this movement is bigger than any company. 
          We're building infrastructure for a multi-decade shift in how humanity 
          consumes content. Transparency and community ownership are core to that mission.
        </p>
